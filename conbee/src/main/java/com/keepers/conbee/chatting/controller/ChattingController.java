...
//    	log.info("파람 맵 : " + paramMap);
	...
	/*
		*//**
			 ...
			 * @return
			 *//*
				 * @GetMapping(value="/chatting/selectTeamMessageList",
				 * produces="application/json; charset=UTF-8;")
				 * 
				 * @ResponseBody public List<ChatMessage>
				 * selectTeamMessageList(@SessionAttribute("loginMember") Member loginMember,
				 * Model model) { List<ChatMessage> teamMessageList =
				 * service.teamList(loginMember.getTeamNo());
				 * 
