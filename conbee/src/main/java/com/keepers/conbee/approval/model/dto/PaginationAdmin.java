...
public class PaginationAdmin {
	...
	private int limit = 10;         // 한 페이지 목록에 보여지는 게시글 수(10개)
	...
	public PaginationAdmin(int currentPage, int reviewCount) {
	...
	public PaginationAdmin(int currentPage, int reviewCount, int limit, int pageSize) {
		this.currentPage = currentPage;
		this.reviewCount = reviewCount;
		this.limit = limit;
