...
public class CalendarController {
	 ...
	 * @return
	 */
	@PutMapping("staffcalendar")
	@ResponseBody
	public int myPageStaffUpdate(@RequestBody Calendar calendar) {
	 ...
	 * @return
	 */
	@DeleteMapping("staffcalendar")
	@ResponseBody
	public int myPageStaffDelete(@RequestBody int calNo) {
		return service.deleteCalendar(calNo);
	}
