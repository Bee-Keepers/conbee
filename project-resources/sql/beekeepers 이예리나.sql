...
SELECT AL.APPROVAL_DATE , AL.APPROVAL_TITLE , AL.APPROVAL_CONTENT , DECODE(AL.DEPARTMENT_NO, 1, '인사관리부', 2, '경영관리부', 3, '운영관리부', 4, '고객관리부', 0, '임원부') DEPARTMENT_TITLE,
