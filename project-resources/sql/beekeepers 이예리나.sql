...
REPORT_ANSWER , BOARD_NO , MEMBER_NAME,
(SELECT MEMBER_NAME FROM BOARD B JOIN MEMBER M ON (B.MEMBER_NO= M.MEMBER_NO)  --게시글 작성자 이름
WHERE R.BOARD_NO = B.BOARD_NO) WRITER_NAME
FROM REPORT R
JOIN MEMBER M USING (MEMBER_NO)
;

-- 신고된 댓글 목록 내용 불러오기
SELECT REPORT_COMMNET_NO , REPORT_COMMNET_TITLE , REPORT_COMMNET_KIND ,
REPORT_COMMNET_ANSWER , BOARD_NO , MEMBER_NAME, BOARD_COMMENT_NO,
...
-- 댓글번호가 있는 경우 댓글 신고횟수 세기
-- 댓글번호가 없는 경우 게시글 신고횟수 세기
